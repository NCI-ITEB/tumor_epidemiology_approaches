...
First we will download the folder we have created for this session. This zipped folder, session8_dndscv.zip, can be downloaded <a href="https://github.com/NCI-ITEB/tumor_epidemiology_approaches_materials/raw/main/practical_materials/practical_8/session8_dndscv.zip" target="_blank">here</a>.
...
This RefCDS object contains data and information for the coding sequence data for each gene included in the object. Download this file from the github dndscv_data repository:
...
**2\.** Today’s example will only use one sample from the _Sherlock-Lung_ project, due to time restraints. Click <a href="https://github.com/NCI-ITEB/tumor_epidemiology_approaches_materials/raw/main/practical_materials/practical_8/NSLC-0005_example.txt.gz" target="_blank">here</a> to download the file with mutation data for one sample, NSLC-0005.
